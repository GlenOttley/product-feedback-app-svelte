...
<article class="bg-white rounded-[10px] p-6   border-t-[6px] border-{color}">
	<div class="grid">
		...
		<div class="upvotes">
			...
			>
				...
				<button
					class={`z-10 py-2 px-4 text-xs font-semibold rounded-[10px] gap-2 flex items-center max-w-fit    hover:bg-blue-100 min-w-[40px] 
